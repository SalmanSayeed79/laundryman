...
export default function CartItem({name,price,count}) {
    ...
    return (
        ...
        <Paper elevation={5} sx={{width:{xs:"95vw",md:"80vw"},minHeight:{xs:"10vh",md:"10vh"},display:"flex",alignItems:"center",flexDirection:{xs:"column",md:"row"},justifyContent:"space-around",marginBottom:"2rem"}}>
